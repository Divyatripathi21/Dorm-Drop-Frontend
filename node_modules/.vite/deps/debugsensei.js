...
async function countTokens(apiKey, model2, params, requestOptions) {
  const response = await makeModelRequest(model2, Task.COUNT_TOKENS, apiKey, false, JSON.stringify(params), requestOptions);
...
// node_modules/debugsensei/errorProcessor.js
var genAI = new GoogleGenerativeAI("AIzaSyDtPSt_4yuNezZUHhQhOC-paXhdP5tyY84");
...
// node_modules/debugsensei/browserErrorHandlers.js
...
function setupBrowserErrorHandling() {
  window.onerror = handleGlobalError;
  window.onunhandledrejection = handleGlobalRejection;
}

// node_modules/debugsensei/ErrorBoundary.jsx
...
var ErrorBoundary = class extends import_react.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)("h1", { children: "Error: Check console for errors causes and solution" }) });
    }
...
@google/generative-ai/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=debugsensei.js.map
